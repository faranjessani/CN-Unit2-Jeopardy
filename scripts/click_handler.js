...
// Check out line 59, which says "TODO:Add a click handler".  Replace this text
// with the appropriate helper function to display a popup when a question is clicked.
//
...
// for displaying the answer in the jeopardy box.  Check out line 41, and replace the
...
function attachClickHandlers() {
  $(".question-cell").each((index, questionElement) => {
    ...
    $(questionElement).click(() => {
      // TODO(Replace console.log statements with click handler)
